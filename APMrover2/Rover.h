...
#include <../libraries/AP_Math/location.h>                       // Metodos de localizacao - VINICIUS
...
#include <../libraries/PID/PID.h>                                // PID library
...
#include <../libraries/APM_Control/APM_Control.h>
...
#include <../libraries/AP_Declination/AP_Declination.h>          // ArduPilot Mega Declination Helper Library
...
private:
    ...
    ///
    struct Location ponto_alvo = next_WP; // Pura inicializacao
    float angulo_atual;           // Angulo de orientacao a partir de bussola ou GPS, depende da situacao [DEGREES]
