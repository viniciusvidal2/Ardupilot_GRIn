...
const AP_Param::Info Rover::var_info[] = {
    ...
    // @Param: VEL_MIN_GPS
    // @DisplayName: Velocidade minima GPS
    // @Description: A partir dessa velocidade a orientacao passa a vir do gps, nao da bussola
    // @User: Advanced
    // @Units: cms
    // @Range: 0 1000
    // @Increment: 1
    GSCALAR(vel_min_gps,  "VEL_MIN_GPS",     300),

    // @Param: ALTURA_DO_CARRO
    // @DisplayName: Altura do carro
    // @Description: Altura de onde a camera esta no carro
    // @User: Advanced
    // @Units: cm
    // @Range: 0 1000
    // @Increment: 1
    GSCALAR(altura_carro,  "ALTURA_CARRO",   200),
