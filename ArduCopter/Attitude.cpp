...
void Copter::alocation_matrix(float &FX,float &FY,float &TN,float &Theta1,float &Theta2,float &Theta3,float &Theta4,float &PWM1,float &PWM2,float &PWM3,float &PWM4)
{
    ...
    FT = fabs(FX*Fmax) + fabs(FY*Fmax) + fabs((TN/L)*Nmax);
    ...
    (fabs(FX)<3e-1f) ? FX = 1e-1f:0.0f;
    (fabs(FY)<3e-1f) ? FY = 1e-1f:0.0f;

    (fabs(FT-FY)< 3e-1f) ? FT = FY + 1e-1f:0.0f;
    (fabs(FT-FX)< 3e-1f) ? FT = FX + 1e-1f:0.0f;
...
//        Theta4 = atan2f(((PWM4*(PWM1 + PWM2 + PWM3 + PWM4)*(FY*sq(Ly)*powf(PWM1,4) + FY*sq(Ly)*powf(PWM3,4) - Ly*powf(PWM1,4)*TN - Ly*powf(PWM3,4)*TN - Ly*sq(PWM1)*sq(PWM2)*TN - 2*Ly*sq(PWM1)*sq(PWM3)*TN - Ly*sq(PWM1)*sq(PWM4)*TN - Ly*sq(PWM2)*sq(PWM3)*TN - Ly*sq(PWM3)*sq(PWM4)*TN + 2*FY*sq(Lx)*sq(PWM1)*sq(PWM2) + 2*FY*sq(Lx)*sq(PWM1)*sq(PWM3) + 2*FY*sq(Lx)*sq(PWM2)*sq(PWM4) + 2*FY*sq(Lx)*sq(PWM3)*sq(PWM4) + FY*sq(Ly)*sq(PWM1)*sq(PWM2) + 2*FY*sq(Ly)*sq(PWM1)*sq(PWM3) + FY*sq(Ly)*sq(PWM1)*sq(PWM4) + FY*sq(Ly)*sq(PWM2)*sq(PWM3) + FY*sq(Ly)*sq(PWM3)*sq(PWM4) - FX*Lx*Ly*powf(PWM1,4) + FX*Lx*Ly*powf(PWM3,4) + FX*Lx*Ly*sq(PWM1)*sq(PWM2) - FX*Lx*Ly*sq(PWM1)*sq(PWM4) + FX*Lx*Ly*sq(PWM2)*sq(PWM3) - FX*Lx*Ly*sq(PWM3)*sq(PWM4)))/(FT*(sq(PWM1) + sq(PWM2) + sq(PWM3) + sq(PWM4))*(sq(Lx)*sq(PWM1)*sq(PWM2) + sq(Lx)*sq(PWM1)*sq(PWM3) + sq(Lx)*sq(PWM2)*sq(PWM4) + sq(Lx)*sq(PWM3)*sq(PWM4) + sq(Ly)*sq(PWM1)*sq(PWM2) + sq(Ly)*sq(PWM1)*sq(PWM4) + sq(Ly)*sq(PWM2)*sq(PWM3) + sq(Ly)*sq(PWM3)*sq(PWM4)))),((PWM4*(PWM1 + PWM2 + PWM3 + PWM4)*(FX*sq(Lx)*powf(PWM2,4) + FX*sq(Lx)*powf(PWM3,4) - Lx*powf(PWM2,4)*TN - Lx*powf(PWM3,4)*TN - Lx*sq(PWM1)*sq(PWM2)*TN - Lx*sq(PWM1)*sq(PWM3)*TN - 2*Lx*sq(PWM2)*sq(PWM3)*TN - Lx*sq(PWM2)*sq(PWM4)*TN - Lx*sq(PWM3)*sq(PWM4)*TN + FX*sq(Lx)*sq(PWM1)*sq(PWM2) + FX*sq(Lx)*sq(PWM1)*sq(PWM3) + 2*FX*sq(Lx)*sq(PWM2)*sq(PWM3) + FX*sq(Lx)*sq(PWM2)*sq(PWM4) + FX*sq(Lx)*sq(PWM3)*sq(PWM4) + 2*FX*sq(Ly)*sq(PWM1)*sq(PWM2) + 2*FX*sq(Ly)*sq(PWM1)*sq(PWM4) + 2*FX*sq(Ly)*sq(PWM2)*sq(PWM3) + 2*FX*sq(Ly)*sq(PWM3)*sq(PWM4) - FY*Lx*Ly*powf(PWM2,4) + FY*Lx*Ly*powf(PWM3,4) + FY*Lx*Ly*sq(PWM1)*sq(PWM2) + FY*Lx*Ly*sq(PWM1)*sq(PWM3) - FY*Lx*Ly*sq(PWM2)*sq(PWM4) - FY*Lx*Ly*sq(PWM3)*sq(PWM4)))/(FT*(sq(PWM1) + sq(PWM2) + sq(PWM3) + sq(PWM4))*(sq(Lx)*sq(PWM1)*sq(PWM2) + sq(Lx)*sq(PWM1)*sq(PWM3) + sq(Lx)*sq(PWM2)*sq(PWM4) + sq(Lx)*sq(PWM3)*sq(PWM4) + sq(Ly)*sq(PWM1)*sq(PWM2) + sq(Ly)*sq(PWM1)*sq(PWM4) + sq(Ly)*sq(PWM2)*sq(PWM3) + sq(Ly)*sq(PWM3)*sq(PWM4)))));
        ...
        Theta1 = atan2f(((k1*((TN*(Ly*PWM1*sq(PWM2) + Ly*PWM1*sq(PWM4)))/(2*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)) + (FY*(sq(Ly)*PWM1*powf(PWM2,4) + sq(Ly)*PWM1*powf(PWM4,4) + 2*sq(Lx)*powf(PWM1,3)*sq(PWM2) + 2*sq(Lx)*powf(PWM1,3)*sq(PWM3) + sq(Ly)*powf(PWM1,3)*sq(PWM2) + sq(Ly)*powf(PWM1,3)*sq(PWM4) + 2*sq(Lx)*PWM1*sq(PWM2)*sq(PWM4) + 2*sq(Lx)*PWM1*sq(PWM3)*sq(PWM4) + sq(Ly)*PWM1*sq(PWM2)*sq(PWM3) + 2*sq(Ly)*PWM1*sq(PWM2)*sq(PWM4) + sq(Ly)*PWM1*sq(PWM3)*sq(PWM4)))/(2*(sq(PWM1)*k1 + sq(PWM2)*k1 + sq(PWM3)*k1 + sq(PWM4)*k1)*(sq(Lx)*sq(PWM1)*sq(PWM2) + sq(Lx)*sq(PWM1)*sq(PWM3) + sq(Lx)*sq(PWM2)*sq(PWM4) + sq(Lx)*sq(PWM3)*sq(PWM4) + sq(Ly)*sq(PWM1)*sq(PWM2) + sq(Ly)*sq(PWM1)*sq(PWM4) + sq(Ly)*sq(PWM2)*sq(PWM3) + sq(Ly)*sq(PWM3)*sq(PWM4))) + (FX*(Ly*PWM1*sq(PWM2) + Ly*PWM1*sq(PWM4))*(Lx*sq(PWM1) - Lx*sq(PWM2) - Lx*sq(PWM3) + Lx*sq(PWM4)))/(2*(sq(PWM1) + sq(PWM2) + sq(PWM3) + sq(PWM4))*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)))*(PWM1 + PWM2 + PWM3 + PWM4))/FT),((k1*((FX*(sq(Lx)*PWM1*powf(PWM2,4) + sq(Lx)*PWM1*powf(PWM3,4) + sq(Lx)*powf(PWM1,3)*sq(PWM2) + sq(Lx)*powf(PWM1,3)*sq(PWM3) + 2*sq(Ly)*powf(PWM1,3)*sq(PWM2) + 2*sq(Ly)*powf(PWM1,3)*sq(PWM4) + 2*sq(Lx)*PWM1*sq(PWM2)*sq(PWM3) + sq(Lx)*PWM1*sq(PWM2)*sq(PWM4) + sq(Lx)*PWM1*sq(PWM3)*sq(PWM4) + 2*sq(Ly)*PWM1*sq(PWM2)*sq(PWM3) + 2*sq(Ly)*PWM1*sq(PWM3)*sq(PWM4)))/(2*(sq(PWM1)*k1 + sq(PWM2)*k1 + sq(PWM3)*k1 + sq(PWM4)*k1)*(sq(Lx)*sq(PWM1)*sq(PWM2) + sq(Lx)*sq(PWM1)*sq(PWM3) + sq(Lx)*sq(PWM2)*sq(PWM4) + sq(Lx)*sq(PWM3)*sq(PWM4) + sq(Ly)*sq(PWM1)*sq(PWM2) + sq(Ly)*sq(PWM1)*sq(PWM4) + sq(Ly)*sq(PWM2)*sq(PWM3) + sq(Ly)*sq(PWM3)*sq(PWM4))) - (TN*(Lx*PWM1*sq(PWM2) + Lx*PWM1*sq(PWM3)))/(2*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)) + (FY*(Lx*PWM1*sq(PWM2) + Lx*PWM1*sq(PWM3))*(Ly*sq(PWM1) - Ly*sq(PWM2) + Ly*sq(PWM3) - Ly*sq(PWM4)))/(2*(sq(PWM1) + sq(PWM2) + sq(PWM3) + sq(PWM4))*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)))*(PWM1 + PWM2 + PWM3 + PWM4))/FT));
        Theta2 = atan2f((-(k1*((TN*(Ly*sq(PWM1)*PWM2 + Ly*PWM2*sq(PWM3)))/(2*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)) - (FY*(sq(Ly)*powf(PWM1,4)*PWM2 + sq(Ly)*PWM2*powf(PWM3,4) + 2*sq(Lx)*sq(PWM1)*powf(PWM2,3) + 2*sq(Lx)*powf(PWM2,3)*sq(PWM4) + sq(Ly)*sq(PWM1)*powf(PWM2,3) + sq(Ly)*powf(PWM2,3)*sq(PWM3) + 2*sq(Lx)*sq(PWM1)*PWM2*sq(PWM3) + 2*sq(Lx)*PWM2*sq(PWM3)*sq(PWM4) + 2*sq(Ly)*sq(PWM1)*PWM2*sq(PWM3) + sq(Ly)*sq(PWM1)*PWM2*sq(PWM4) + sq(Ly)*PWM2*sq(PWM3)*sq(PWM4)))/(2*(sq(PWM1)*k1 + sq(PWM2)*k1 + sq(PWM3)*k1 + sq(PWM4)*k1)*(sq(Lx)*sq(PWM1)*sq(PWM2) + sq(Lx)*sq(PWM1)*sq(PWM3) + sq(Lx)*sq(PWM2)*sq(PWM4) + sq(Lx)*sq(PWM3)*sq(PWM4) + sq(Ly)*sq(PWM1)*sq(PWM2) + sq(Ly)*sq(PWM1)*sq(PWM4) + sq(Ly)*sq(PWM2)*sq(PWM3) + sq(Ly)*sq(PWM3)*sq(PWM4))) + (FX*(Ly*sq(PWM1)*PWM2 + Ly*PWM2*sq(PWM3))*(Lx*sq(PWM1) - Lx*sq(PWM2) - Lx*sq(PWM3) + Lx*sq(PWM4)))/(2*(sq(PWM1) + sq(PWM2) + sq(PWM3) + sq(PWM4))*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)))*(PWM1 + PWM2 + PWM3 + PWM4))/FT),((k1*((TN*(Lx*sq(PWM1)*PWM2 + Lx*PWM2*sq(PWM4)))/(2*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)) + (FX*(sq(Lx)*powf(PWM1,4)*PWM2 + sq(Lx)*PWM2*powf(PWM4,4) + sq(Lx)*sq(PWM1)*powf(PWM2,3) + sq(Lx)*powf(PWM2,3)*sq(PWM4) + 2*sq(Ly)*sq(PWM1)*powf(PWM2,3) + 2*sq(Ly)*powf(PWM2,3)*sq(PWM3) + sq(Lx)*sq(PWM1)*PWM2*sq(PWM3) + 2*sq(Lx)*sq(PWM1)*PWM2*sq(PWM4) + sq(Lx)*PWM2*sq(PWM3)*sq(PWM4) + 2*sq(Ly)*sq(PWM1)*PWM2*sq(PWM4) + 2*sq(Ly)*PWM2*sq(PWM3)*sq(PWM4)))/(2*(sq(PWM1)*k1 + sq(PWM2)*k1 + sq(PWM3)*k1 + sq(PWM4)*k1)*(sq(Lx)*sq(PWM1)*sq(PWM2) + sq(Lx)*sq(PWM1)*sq(PWM3) + sq(Lx)*sq(PWM2)*sq(PWM4) + sq(Lx)*sq(PWM3)*sq(PWM4) + sq(Ly)*sq(PWM1)*sq(PWM2) + sq(Ly)*sq(PWM1)*sq(PWM4) + sq(Ly)*sq(PWM2)*sq(PWM3) + sq(Ly)*sq(PWM3)*sq(PWM4))) - (FY*(Lx*sq(PWM1)*PWM2 + Lx*PWM2*sq(PWM4))*(Ly*sq(PWM1) - Ly*sq(PWM2) + Ly*sq(PWM3) - Ly*sq(PWM4)))/(2*(sq(PWM1) + sq(PWM2) + sq(PWM3) + sq(PWM4))*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)))*(PWM1 + PWM2 + PWM3 + PWM4))/FT));
        Theta3 = atan2f(((k1*((TN*(Ly*sq(PWM2)*PWM3 + Ly*PWM3*sq(PWM4)))/(2*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)) + (FY*(sq(Ly)*powf(PWM2,4)*PWM3 + sq(Ly)*PWM3*powf(PWM4,4) + 2*sq(Lx)*sq(PWM1)*powf(PWM3,3) + 2*sq(Lx)*powf(PWM3,3)*sq(PWM4) + sq(Ly)*sq(PWM2)*powf(PWM3,3) + sq(Ly)*powf(PWM3,3)*sq(PWM4) + 2*sq(Lx)*sq(PWM1)*sq(PWM2)*PWM3 + 2*sq(Lx)*sq(PWM2)*PWM3*sq(PWM4) + sq(Ly)*sq(PWM1)*sq(PWM2)*PWM3 + sq(Ly)*sq(PWM1)*PWM3*sq(PWM4) + 2*sq(Ly)*sq(PWM2)*PWM3*sq(PWM4)))/(2*(sq(PWM1)*k1 + sq(PWM2)*k1 + sq(PWM3)*k1 + sq(PWM4)*k1)*(sq(Lx)*sq(PWM1)*sq(PWM2) + sq(Lx)*sq(PWM1)*sq(PWM3) + sq(Lx)*sq(PWM2)*sq(PWM4) + sq(Lx)*sq(PWM3)*sq(PWM4) + sq(Ly)*sq(PWM1)*sq(PWM2) + sq(Ly)*sq(PWM1)*sq(PWM4) + sq(Ly)*sq(PWM2)*sq(PWM3) + sq(Ly)*sq(PWM3)*sq(PWM4))) + (FX*(Ly*sq(PWM2)*PWM3 + Ly*PWM3*sq(PWM4))*(Lx*sq(PWM1) - Lx*sq(PWM2) - Lx*sq(PWM3) + Lx*sq(PWM4)))/(2*(sq(PWM1) + sq(PWM2) + sq(PWM3) + sq(PWM4))*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)))*(PWM1 + PWM2 + PWM3 + PWM4))/FT),((k1*((TN*(Lx*sq(PWM1)*PWM3 + Lx*PWM3*sq(PWM4)))/(2*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)) + (FX*(sq(Lx)*powf(PWM1,4)*PWM3 + sq(Lx)*PWM3*powf(PWM4,4) + sq(Lx)*sq(PWM1)*powf(PWM3,3) + sq(Lx)*powf(PWM3,3)*sq(PWM4) + 2*sq(Ly)*sq(PWM2)*powf(PWM3,3) + 2*sq(Ly)*powf(PWM3,3)*sq(PWM4) + sq(Lx)*sq(PWM1)*sq(PWM2)*PWM3 + 2*sq(Lx)*sq(PWM1)*PWM3*sq(PWM4) + sq(Lx)*sq(PWM2)*PWM3*sq(PWM4) + 2*sq(Ly)*sq(PWM1)*sq(PWM2)*PWM3 + 2*sq(Ly)*sq(PWM1)*PWM3*sq(PWM4)))/(2*(sq(PWM1)*k1 + sq(PWM2)*k1 + sq(PWM3)*k1 + sq(PWM4)*k1)*(sq(Lx)*sq(PWM1)*sq(PWM2) + sq(Lx)*sq(PWM1)*sq(PWM3) + sq(Lx)*sq(PWM2)*sq(PWM4) + sq(Lx)*sq(PWM3)*sq(PWM4) + sq(Ly)*sq(PWM1)*sq(PWM2) + sq(Ly)*sq(PWM1)*sq(PWM4) + sq(Ly)*sq(PWM2)*sq(PWM3) + sq(Ly)*sq(PWM3)*sq(PWM4))) - (FY*(Lx*sq(PWM1)*PWM3 + Lx*PWM3*sq(PWM4))*(Ly*sq(PWM1) - Ly*sq(PWM2) + Ly*sq(PWM3) - Ly*sq(PWM4)))/(2*(sq(PWM1) + sq(PWM2) + sq(PWM3) + sq(PWM4))*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)))*(PWM1 + PWM2 + PWM3 + PWM4))/FT));
        Theta4 = atan2f((-(k1*((TN*(Ly*sq(PWM1)*PWM4 + Ly*sq(PWM3)*PWM4))/(2*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)) - (FY*(sq(Ly)*powf(PWM1,4)*PWM4 + sq(Ly)*powf(PWM3,4)*PWM4 + 2*sq(Lx)*sq(PWM2)*powf(PWM4,3) + 2*sq(Lx)*sq(PWM3)*powf(PWM4,3) + sq(Ly)*sq(PWM1)*powf(PWM4,3) + sq(Ly)*sq(PWM3)*powf(PWM4,3) + 2*sq(Lx)*sq(PWM1)*sq(PWM2)*PWM4 + 2*sq(Lx)*sq(PWM1)*sq(PWM3)*PWM4 + sq(Ly)*sq(PWM1)*sq(PWM2)*PWM4 + 2*sq(Ly)*sq(PWM1)*sq(PWM3)*PWM4 + sq(Ly)*sq(PWM2)*sq(PWM3)*PWM4))/(2*(sq(PWM1)*k1 + sq(PWM2)*k1 + sq(PWM3)*k1 + sq(PWM4)*k1)*(sq(Lx)*sq(PWM1)*sq(PWM2) + sq(Lx)*sq(PWM1)*sq(PWM3) + sq(Lx)*sq(PWM2)*sq(PWM4) + sq(Lx)*sq(PWM3)*sq(PWM4) + sq(Ly)*sq(PWM1)*sq(PWM2) + sq(Ly)*sq(PWM1)*sq(PWM4) + sq(Ly)*sq(PWM2)*sq(PWM3) + sq(Ly)*sq(PWM3)*sq(PWM4))) + (FX*(Ly*sq(PWM1)*PWM4 + Ly*sq(PWM3)*PWM4)*(Lx*sq(PWM1) - Lx*sq(PWM2) - Lx*sq(PWM3) + Lx*sq(PWM4)))/(2*(sq(PWM1) + sq(PWM2) + sq(PWM3) + sq(PWM4))*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)))*(PWM1 + PWM2 + PWM3 + PWM4))/FT),((k1*((FX*(sq(Lx)*powf(PWM2,4)*PWM4 + sq(Lx)*powf(PWM3,4)*PWM4 + sq(Lx)*sq(PWM2)*powf(PWM4,3) + sq(Lx)*sq(PWM3)*powf(PWM4,3) + 2*sq(Ly)*sq(PWM1)*powf(PWM4,3) + 2*sq(Ly)*sq(PWM3)*powf(PWM4,3) + sq(Lx)*sq(PWM1)*sq(PWM2)*PWM4 + sq(Lx)*sq(PWM1)*sq(PWM3)*PWM4 + 2*sq(Lx)*sq(PWM2)*sq(PWM3)*PWM4 + 2*sq(Ly)*sq(PWM1)*sq(PWM2)*PWM4 + 2*sq(Ly)*sq(PWM2)*sq(PWM3)*PWM4))/(2*(sq(PWM1)*k1 + sq(PWM2)*k1 + sq(PWM3)*k1 + sq(PWM4)*k1)*(sq(Lx)*sq(PWM1)*sq(PWM2) + sq(Lx)*sq(PWM1)*sq(PWM3) + sq(Lx)*sq(PWM2)*sq(PWM4) + sq(Lx)*sq(PWM3)*sq(PWM4) + sq(Ly)*sq(PWM1)*sq(PWM2) + sq(Ly)*sq(PWM1)*sq(PWM4) + sq(Ly)*sq(PWM2)*sq(PWM3) + sq(Ly)*sq(PWM3)*sq(PWM4))) - (TN*(Lx*sq(PWM2)*PWM4 + Lx*sq(PWM3)*PWM4))/(2*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)) + (FY*(Lx*sq(PWM2)*PWM4 + Lx*sq(PWM3)*PWM4)*(Ly*sq(PWM1) - Ly*sq(PWM2) + Ly*sq(PWM3) - Ly*sq(PWM4)))/(2*(sq(PWM1) + sq(PWM2) + sq(PWM3) + sq(PWM4))*(sq(Lx)*sq(PWM1)*sq(PWM2)*k1 + sq(Lx)*sq(PWM1)*sq(PWM3)*k1 + sq(Lx)*sq(PWM2)*sq(PWM4)*k1 + sq(Lx)*sq(PWM3)*sq(PWM4)*k1 + sq(Ly)*sq(PWM1)*sq(PWM2)*k1 + sq(Ly)*sq(PWM1)*sq(PWM4)*k1 + sq(Ly)*sq(PWM2)*sq(PWM3)*k1 + sq(Ly)*sq(PWM3)*sq(PWM4)*k1)))*(PWM1 + PWM2 + PWM3 + PWM4))/FT));
        ...
        //Tratamento da Singularidade

        float med = (Theta1+Theta2+Theta3+Theta4)/4.0;

        float med1 = fabs(med - Theta1);
        float med2 = fabs(med - Theta2);
        float med3 = fabs(med - Theta3);
        float med4 = fabs(med - Theta4);

        float soma = med1+med2+med3+med4;

        if(soma< 6.0*DEG_TO_RAD)
        {
            Theta1 = Theta1 + 2.5*DEG_TO_RAD;
            Theta2 = Theta2 - 2.5*DEG_TO_RAD;
            Theta3 = Theta3 - 2.5*DEG_TO_RAD;
            Theta4 = Theta4 + 2.5*DEG_TO_RAD;
        }
