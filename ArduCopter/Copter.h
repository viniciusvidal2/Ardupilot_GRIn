...
//    float GanhoF = 1.0f;
    ...
    // User variables
#define USERHOOK_VARIABLES true

#ifdef USERHOOK_VARIABLES
    uint32_t teste_wp2 = 3333;
#endif
...
#define MOTOR_CLASS AP_MotorsMulticopter
    ...
    void Diferential_alocation_matrix(float &FX,float &FY,float &tN,float &theta_motor1,float &theta_motor2,float &theta_motor3,float &theta_motor4,float &PWM1 ,float &PWM2 ,float &PWM3 ,float &PWM4);
