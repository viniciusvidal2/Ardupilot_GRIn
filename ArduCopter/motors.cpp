...
//#include <../libraries/eigen/Eigen/Core>
//#include <../libraries/eigen/Eigen/Geometry>
//#include <../libraries/eigen/Eigen/LU>
...
//MURILLO
// motors_output - send output to motors library which will adjust and send to ESCs and servos
void Copter::motors_output(float &mt1, float &mt2, float &mt3, float &mt4, float &F_x1, float &F_z1, float &T_r1, float &T_p1, float &T_y1, float &srv51, float &srv61, float &srv71, float &srv81, int tp)
{
#if ADVANCED_FAILSAFE == ENABLED
    // this is to allow the failsafe module to deliberately crash
    // the vehicle. Only used in extreme circumstances to meet the
    ...
    if (ap.motor_test) {
        ...
        // send output signals to motors
        motors->output(mt1, mt2, mt3, mt4, F_x1, F_z1, T_r1, T_p1, T_y1, srv51, srv61, srv71, srv81, tp);
    }
