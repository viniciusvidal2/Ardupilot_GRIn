...
//    servo_m3 = 500+(channel_throttle->get_radio_in()-channel_throttle->get_radio_min())+ 2.0*(canalservo->get_radio_in()-canalservo->get_radio_min());

    servo_m1 = servo_angle_to_pwm(theta_m1,675.0,2329.0);
    servo_m2 = servo_angle_to_pwm(theta_m2,664.0,2144.0);
    servo_m3 = servo_angle_to_pwm(theta_m3,854.0,2400.0);
