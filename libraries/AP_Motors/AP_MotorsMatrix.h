...
public:
    ...
    // MURILLO
    // output_to_motors - sends minimum values out to the motors
    void                output_to_motors(int srv_5, int srv_6, int srv_7, int srv_8);
...
protected:
    ...
    void                output_armed_stabilizing(float &mtr1, float &mtr2, float &mtr3, float &mtr4, float &Fx, float &thr_MFS, float &roll_MFS, float &pitch_MFS, float &yaw_MFS, float &srv5, float &srv6, float &srv7, float &srv8, int tp);
    void                tilt_angle_full_TRUAV(int tp, float &mtr1, float &mtr2, float &mtr3, float &mtr4, float &srv5, float &srv6, float &srv7, float &srv8, float Fx, float Fz, float T_roll, float T_pitch, float T_yaw);
