...
// MURILLO //
///////////////////////
double AP_MotorsMulticopter::norm_Pitch_Channel()
{
    double vlr, norm;
    ...
    if(vlr<800.0){
        ...
        norm = (double)(_reversePitch)*((double)(_mid_chn_Pitch) - (double)(vlr))/((double)(_mid_chn_Pitch) - (double)(_min_chn_Pitch));
    }
...
///////////////////////
// output - sends commands to the motors
void AP_MotorsMulticopter::output(float &srv5, float &srv6, float &srv7, float &srv8, int tp)
{
    // update throttle filter
    update_throttle_filter();
