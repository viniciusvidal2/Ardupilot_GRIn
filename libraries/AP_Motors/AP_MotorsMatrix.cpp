...
//        srv8    = asinf(arcsin4);
    ...
    srv5 = srv5*rad2deg*1.0;   // *10 é para aproximar 1 grau a 10 micro_us
    srv6 = srv6*rad2deg*1.0;
    srv7 = srv7*rad2deg*1.0;
    ...
    _last2_Srv6 = _last2_Srv6*rad2deg*1.0;
    _last2_Srv7 = _last2_Srv7*rad2deg*1.0;
    _last2_Srv8 = _last2_Srv8*rad2deg*1.0;
