...
protected:
    ...
    virtual void        output_armed_stabilizing(float &mtr1, float &mtr2, float &mtr3, float &mtr4, float &Fx, float &thr_MFS, float &roll_MFS, float &pitch_MFS, float &yaw_MFS, float &srv5, float &srv6, float &srv7, float &srv8, int tp)=0;
